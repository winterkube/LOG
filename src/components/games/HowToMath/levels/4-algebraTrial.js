...
function randomEq1(huh, vari) {
    if (huh === 1) {
        ...
        const b = Math.floor(Math.random() * 11) - 5; // b ∈ [-5, 5]
...
export const algebraTrial = {
    ...
    questions: [
        ...
        { question: randomEq1(1,'x') , variable: 'x', answer: 'idk', time: (60 / bpm) * 4 },
        { question: randomEq1(1,'x') , variable: 'x', answer: 'idk', time: (60 / bpm) * 7 },
        { question: randomNum1(6) + 'y + ' + randomNum1(2) + ' = ' + randomNum1(7) + 'y' , variable: 'y', answer: 'idk', time: (60 / bpm) * 8 },
        { question: randomNum1(2) + ' + ' + randomNum1(6) + 'z' + ' = ' + randomNum1(7) + 'z' , variable: 'z', answer: 'idk', time: (60 / bpm) * 9 },

        { question: randomNum1(4) + ' = x + ' + randomNum1(4), variable: 'x', answer: 'idk', time: (60 / bpm) * 6 },
        { question: randomNum1(4) + ' = -a + ' + randomNum1(4), variable: 'a', answer: 'idk', time: (60 / bpm) * 5 },
        { question: randomNum1(4) + ' = b + ' + randomNum1(4) + 'b', variable: 'b', answer: 'idk', time: (60 / bpm) * 5 }, // 16

        { question: randomNum1() + ' = v / ' + randomNum1(), variable: 'v', answer: 'idk', time: (60 / bpm) * 3 },
        { question: randomNum1() + ' = 2M - M + ' + randomNum1(1), variable: 'M', answer: 'idk', time: (60 / bpm) * 5 }, // 8
